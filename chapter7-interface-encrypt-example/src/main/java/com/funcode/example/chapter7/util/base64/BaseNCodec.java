...
public abstract class BaseNCodec implements BinaryEncoder, BinaryDecoder {
    ...
    protected static byte[] getBytes(final String string, final Charset charset) {
        if (string == null) {
            return null;
        }
    ...
    protected static String newString(final byte[] bytes, final Charset charset) {
        return bytes == null ? null : new String(bytes, charset);
    }

    protected static String newStringUsAscii(final byte[] bytes) {
